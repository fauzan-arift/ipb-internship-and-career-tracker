...
const HRDetail = () => {
  ...
  const handleApprove = async () => {
    ...
    try {
      const res = await api.post(
        `/admin/hr/profile/${profileId}/approve`
      );
  ...
  const handleReject = async (reason) => {
    ...
    try {
      const res = await api.post(
        `/admin/hr/profile/${profileId}/reject`,
        { reason }
      );
  ...
  const isVerified =
    statusStr.toLowerCase() === 'verified';
  ...
  const infoFields = [
    ...
    {
      label: 'Industri',
      value: detail.company?.industry,
    },
    {
      label: 'Email Perusahaan',
      value: detail.company?.company_email,
    },
    {
      label: 'Website',
      value: detail.company?.website,
    },
    {
  ...
  const registeredAtRaw =
    ...
    detail?.company?.registered_at ??
    detail?.created_at ??
    detail?.hr?.created_at ??
    null;

  const registeredAt = registeredAtRaw
    ? new Date(registeredAtRaw).toLocaleDateString(
        'id-ID',
        {
          day: 'numeric',
          month: 'short',
          ...
          <>
            ...
            >
              ...
              <DescriptionBox
                ...
                value={detail.company?.description}
              />
            </InfoSectionCard>
          </>
        }
